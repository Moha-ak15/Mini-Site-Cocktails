...
--
-- Host: localhost:8889
-- Generation Time: Feb 12, 2021 at 03:44 PM
...
(6, 'Punch Test', 'Historiquement, le punch date du XVIe siècle. Il aurait été créé par des marins britanniques en mélangeant du Tafia (un genre de rhum brut) qui était embarqué sur les navires, avec d’autres ingrédients.', 'punch.jpg', '1532-01-01', 9, 2),
...
(21, 'French 755', 'Le French 75 est un cocktail à base de gin, jus de citron, de sucre et de champagne. Le nom du cocktail fait référence au canon de 75 mm modèle 1897.', '6024e84f96f43-French_75.jpeg', '1897-01-01', 13, 4);
...
INSERT INTO `Ingredient` (`id`, `nomIngredient`) VALUES
(9, 'chocolat'),
(8, 'coco'),
(1, 'fraise'),
(7, 'menthe');
...
--
-- Table structure for table `relationCocktailIngredient`
--

CREATE TABLE `relationCocktailIngredient` (
  `idCocktail` int(11) NOT NULL,
  `idIngredient` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `relationCocktailIngredient`
--

INSERT INTO `relationCocktailIngredient` (`idCocktail`, `idIngredient`) VALUES
(10, 1),
(10, 9),
(10, 8);
...
--
-- Indexes for table `relationCocktailIngredient`
--
ALTER TABLE `relationCocktailIngredient`
...
--
-- Constraints for table `relationCocktailIngredient`
--
ALTER TABLE `relationCocktailIngredient`
  ADD CONSTRAINT `relationcocktailingredient_ibfk_1` FOREIGN KEY (`idCocktail`) REFERENCES `Cocktail` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `relationcocktailingredient_ibfk_2` FOREIGN KEY (`idIngredient`) REFERENCES `Ingredient` (`id`) ON UPDATE CASCADE;
